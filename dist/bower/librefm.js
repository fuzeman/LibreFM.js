(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("querystring"), require("whatwg-fetch"), require("crypto-js/enc-hex"), require("crypto-js/md5"), require("lodash-amd/object/merge"));
	else if(typeof define === 'function' && define.amd)
		define(["querystring", "whatwg-fetch", "crypto-js/enc-hex", "crypto-js/md5", "lodash-amd/object/merge"], factory);
	else if(typeof exports === 'object')
		exports["librefm"] = factory(require("querystring"), require("whatwg-fetch"), require("crypto-js/enc-hex"), require("crypto-js/md5"), require("lodash-amd/object/merge"));
	else
		root["librefm"] = factory(root["querystring"], root["whatwg-fetch"], root["crypto-js/enc-hex"], root["crypto-js/md5"], root["lodash-amd/object/merge"]);
